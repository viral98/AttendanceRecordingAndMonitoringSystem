    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Add Teacher</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        ...
        <form id="senddata" method="_GET">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="teach_id" name="teach_id">
            <label class="mdl-textfield__label" for="teach_id">Teacher Id...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>          
          </div>
          <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="teach_name" name="teach_name">
            <label class="mdl-textfield__label" for="teach_name">Teacher Name...</label>
          </div>
        <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="dept_num" name="dept_num">
            <label class="mdl-textfield__label" for="dept_num">Department Number...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>          
          </div>
        <br>
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="rfid" name="rfid">
            <label class="mdl-textfield__label" for="rfid">RFID...</label>
          </div>
                  <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="date" date ="yyyy-mm-dd" id="doj" name="doj">
            <label class="mdl-textfield__label" for="doj">Date Of Joining...</label>
      ...
      <div>
        <?php
          ...
          if (isset($_GET["search"]))
          {
              ...
              $teach_name=$_GET["teach_name"];
              $rfid=$_GET["rfid"];
              $dept_num=$_GET["dept_num"];
              $doj=$_GET["doj"];
              $sql="INSERT INTO teacher values ('$teach_id','$teach_name','$dept_num','$rfid','$doj')";
              //mysqli_query($conn,"INSERT INTO student values ($rollno,$name,$rfid,$phone,$Dept)");

    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Subject Registeration</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <form id="senddata" method="_GET">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="StudentID" name="StudentID">
            <label class="mdl-textfield__label" for="StudentID">StudentID...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>          
          </div>
          <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="SubjectID" name="SubjectID">
            <label class="mdl-textfield__label" for="SubjectID">SubjectID...</label>
          </div>
        <br>
        <br>
          <div>
      ...
      <div>
        <?php
          ...
          {
            $sqlrollnosubcode="SELECT COUNT(*) as NumLec FROM student.sub_reg ";
              ...
              $subjectcode=$_GET["SubjectID"];
              $sql="INSERT INTO student.sub_reg values ($srno,$StudentID,$subjectcode)";

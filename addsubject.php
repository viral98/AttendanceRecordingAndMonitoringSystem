    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Add Subject</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        ...
        <form id="senddata" method="_GET">
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="SubjectCode" name="SubjectCode">
            <label class="mdl-textfield__label" for="SubjectCode">Subject Code...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>          
          </div>
          <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="SubjectName" name="SubjectName">
            <label class="mdl-textfield__label" for="SubjectName">Subject Name...</label>
          </div>
        <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="TeacherID" name="TeacherID">
            <label class="mdl-textfield__label" for="TeacherID">Teacher ID...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>          
          </div>
        <br>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      ...
      <div>
        <?php
          ...
          if (isset($_GET["search"]))
          {
              ...
              $Dept=$_GET["DeptID"];
              $sql="INSERT INTO subject values ('$SubjectCode','$name','$Dept','$TeacherID','0')";
